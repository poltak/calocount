...
export const settings = sqliteTable(
  "settings",
  {
    ...
    vitaminB6UsFnbAdultUlEnabled: integer("vitamin_b6_us_fnb_adult_ul_enabled", { mode: "boolean" }).notNull().default(false),
    vitaminB6UsFnbAdultUlConfirmedAt: integer("vitamin_b6_us_fnb_adult_ul_confirmed_at", { mode: "number" }),
    usFnbAdultUlEnabled: integer("us_fnb_adult_ul_enabled", { mode: "boolean" }).notNull().default(false),
    usFnbAdultUlConfirmedAt: integer("us_fnb_adult_ul_confirmed_at", { mode: "number" }),
...
export const mealItems = sqliteTable(
  "meal_items",
  {
    ...
    vitaminAMcgRae: real("vitamin_a_mcg_rae"),
    ...
    folateMcgDfe: real("folate_mcg_dfe"),
    ...
    preformedVitaminAMcgRae: real("preformed_vitamin_a_mcg_rae"),
    supplementalMagnesiumMg: real("supplemental_magnesium_mg"),
    folicAcidMcg: real("folic_acid_mcg"),
    supplementalVitaminEMg: real("supplemental_vitamin_e_mg"),
    nutrientProvenanceJson: text("nutrient_provenance_json"),
    confidence: real("confidence"),
