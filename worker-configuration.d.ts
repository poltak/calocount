/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 993929c2213cf0f8e36d1a633b5219da)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	CALOCOUNT_MCP_ACCESS_AUDIENCE: "06fb38f786e5b8f6b1e86e57114f3c4fc689680f3d27b126792070bffaeaddc8";
	CALOCOUNT_ALLOW_LOCAL: string;
	CALOCOUNT_OWNER_KEY: string;
	CALOCOUNT_CHATGPT_MEAL_TOKEN: string;
	CALOCOUNT_ACCESS_TEAM_DOMAIN: string;
	CALOCOUNT_ACCESS_AUDIENCE: string;
	CALOCOUNT_OWNER_EMAIL: string;
	CALOCOUNT_ALLOWED_EMAIL: string;
	CALOCOUNT_ALLOWED_EMAIL_SHA256: string;
	CALOCOUNT_ALLOWED_USER_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALOCOUNT_MCP_ACCESS_AUDIENCE" | "CALOCOUNT_ALLOW_LOCAL" | "CALOCOUNT_OWNER_KEY" | "CALOCOUNT_CHATGPT_MEAL_TOKEN" | "CALOCOUNT_ACCESS_TEAM_DOMAIN" | "CALOCOUNT_ACCESS_AUDIENCE" | "CALOCOUNT_OWNER_EMAIL" | "CALOCOUNT_ALLOWED_EMAIL" | "CALOCOUNT_ALLOWED_EMAIL_SHA256" | "CALOCOUNT_ALLOWED_USER_ID">> {}
}
