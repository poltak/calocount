...
test("dashboard renders an accessible selectable-range macros trend", async () => {
  ...
  assert.match(page, /Calorie-weighted carbohydrate, protein, and fat split for the past \$\{trendRange\} days/);
